...
export default function PortfolioImage({
  ...
  const enableModal = image.openModal ?? true;
      ...
      {isModalOpen && (
        ...
        >
          ...
          <div className="relative flex items-center justify-center max-w-[90vw] max-h-[90vh] p-4">
            {image.data ? (
              <Image
                src={image.data}
                alt={image.alt}
                className={`max-w-[85vw] max-h-[85vh] object-contain w-auto h-[85vh] bg-white`}
          ...
          {/* <button
            ...
            className="fixed top-4 right-4 bg-white text-black px-4 py-2 rounded-lg shadow-lg hover:bg-gray-100 transition-colors"
            title="Close (Esc)"
          >
            ✕
          </button> */}
